            ...
            <div class="bg-gray-100 w-full ">
                ...
                <table class="table-auto w-11/12 mx-auto my-5 text-center">
                    ...
                    <tbody>
                        ...
                        <td class="text-center" id="price_prod">${item.price} đ</td>
                        <td id="short" class="w-[50%]">${item.shortDesc}</td>
                        <td>
                            <label for="default-toggle ${item.id}" class="inline-flex relative items-center cursor-pointer">
                                <input ${item.isDelete ? "checked" : ""} type="checkbox" value="${item.isDelete}" id="default-toggle ${item.id}" class="checkDel sr-only peer">
